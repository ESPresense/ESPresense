...
#define SCAN_TASK_STACK_SIZE 5120
#define LOOP_TASK_STACK_SIZE 8192
...
#define MIN_MAX_ALLOC_HEAP 4096
#define BLE_GATTC_UNRESPONSIVE_TIMEOUT_MS 2000
#if CONFIG_FREERTOS_UNICORE
#define LOOP_TASK_CORE 0
#else
