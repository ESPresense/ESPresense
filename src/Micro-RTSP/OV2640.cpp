...
camera_config_t esp32cam_config {
    ...
    .jpeg_quality = 30,               //0-63 lower numbers are higher quality
...
camera_config_t esp32cam_wrover_kit_config {

    .pin_pwdn = -1,     //PWDN_GPIO_NUM
    .pin_reset = -1,    //RESET_GPIO_NUM

    .pin_xclk = 21,      //XCLK_GPIO_NUM

    .pin_sscb_sda = 26, //SIOD_GPIO_NUM
    .pin_sscb_scl = 27, //SIOC_GPIO_NUM

    .pin_d7 = 35,       //Y9_GPIO_NUM
    .pin_d6 = 34,       //Y8_GPIO_NUM
    .pin_d5 = 39,       //Y7_GPIO_NUM
    .pin_d4 = 36,       //Y6_GPIO_NUM
    .pin_d3 = 19,       //Y5_GPIO_NUM
    .pin_d2 = 18,       //Y4_GPIO_NUM
    .pin_d1 = 5,        //Y3_GPIO_NUM
    .pin_d0 = 4,        //Y2_GPIO_NUM
    .pin_vsync = 25,    //VSYNC_GPIO_NUM
    .pin_href = 23,     //HREF_GPIO_NUM
    .pin_pclk = 22,     //PCLK_GPIO_NUM
    .xclk_freq_hz = 20000000,
    .ledc_timer = LEDC_TIMER_1,
    .ledc_channel = LEDC_CHANNEL_1,
    .pixel_format = PIXFORMAT_JPEG,
...
camera_config_t esp_eye_config {
    ...
    .pin_xclk = 4,      //XCLK_GPIO_NUM

    .pin_sscb_sda = 18, //SIOD_GPIO_NUM
    .pin_sscb_scl = 23, //SIOC_GPIO_NUM

    .pin_d7 = 36,       //Y9_GPIO_NUM
    .pin_d6 = 37,       //Y8_GPIO_NUM
    .pin_d5 = 38,       //Y7_GPIO_NUM

    .pin_d4 = 39,       //Y6_GPIO_NUM
    .pin_d3 = 35,       //Y5_GPIO_NUM
    .pin_d2 = 14,       //Y4_GPIO_NUM

    .pin_d1 = 13,        //Y3_GPIO_NUM
    .pin_d0 = 34,        //Y2_GPIO_NUM
    .pin_vsync = 5,    //VSYNC_GPIO_NUM

    .pin_href = 27,     //HREF_GPIO_NUM
    .pin_pclk = 25,     //PCLK_GPIO_NUM
    .xclk_freq_hz = 20000000,
    .ledc_timer = LEDC_TIMER_1,
    .ledc_channel = LEDC_CHANNEL_1,
    .pixel_format = PIXFORMAT_JPEG,
