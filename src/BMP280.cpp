...
namespace BMP280
{
    ...
    void ConnectToWifi()
    {
        WiFiSettings.html("h4", "BMP280 - Weather Sensor:");
        BMP280_I2c_Bus = WiFiSettings.integer("BMP280_I2c_Bus", 1, 2, DEFAULT_I2C_BUS, "I2C Bus");
        BMP280_I2c = WiFiSettings.string("BMP280_I2c", "", "I2C address (0x76 or 0x77)");
    }
